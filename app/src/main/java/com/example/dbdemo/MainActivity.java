...
import com.example.dbdemo.view.CommonDialog;
import com.example.dbdemo.view.ConfigDialog;
import com.example.dbdemo.view.GameOverDialog;
import com.example.dbdemo.view.GameView;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void changeConfiguration(ConfigDialog dialog, int difficulty, boolean volumeState) {
        ...
        // 保存游戏难度
        ConfigManager.putGameDifficulty(MainActivity.this, difficulty);
        // 保存音效设置
        ConfigManager.putGameVolume(this, volumeState);
        dialog.cancel();
    }
    ...
    private class MyReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(GameView.ACTION_RECORD_SCORE)) {
                ...
                GameOverDialog dialog = new GameOverDialog(MainActivity.this, R.style.CustomDialog);
    ...
    private void saveCurrentScore(int score) {
        if (Config.CurrentGameMode == Constant.MODE_CLASSIC) {
            ConfigManager.putCurrentScore(MainActivity.this, score);
        } else {
            ConfigManager.putCurrentScoreWithinInfinite(MainActivity.this, score);
        }
    }
